...
I observe the the outcome "classe" is a descrete variable, not a continious variable. In this case, using decision trees will fit the prediction outcome type of "classe".
